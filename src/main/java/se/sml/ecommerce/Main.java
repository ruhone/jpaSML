...
//		eService.createProduct(product1).addProduct(product2).addProduct(product3);
//		eService.createProduct(product5);
				
//		// get a product by product Id
//		System.out.println(eService.getProductById(33L));
	
//		// get a product by product Name. Fetches a single product because each product name is unique.
//		System.out.println(eService.getProductByName("Pepsssi"));
...
//		list.forEach(prod -> System.out.println(prod)); 
		...
		eService.updateProduct("Colal", 12L, updateProperty);		
